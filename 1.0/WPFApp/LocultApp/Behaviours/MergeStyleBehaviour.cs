    ...
    public class MergeStyleBehaviour
    {
        ...
        private static void OnAutoMergeStyleChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            try
            {
                ...
                if (control == null)
                    throw new NotSupportedException(string.Format("AutoMergeStyle can only be used in a Control (cannot be used on: {0}).",
                                                                                         ...
                                                                                         DependencyPropertyChangedEventArgs e)
        {
            ...
            try
            {
                ...
                if (control == null)
                    throw new NotSupportedException(string.Format("BaseOnStyle can only be used in a Control (cannot be used on: {0}).",
                                                                  (d == null ? "(null)" : d.ToString())));
